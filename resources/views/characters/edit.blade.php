        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{URL::route('characters.update',$char->id)}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xl-12">
                                <input id="pseudo" type="text" class="form-control" name="pseudo" value="{{$char->pseudo}}" required autofocus>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="faction" class="col-md-2 control-label">Faction</label>
                            <div class="col-md-6 col-xl-12">
                                <select id="faction" name="faction" class="form-control" required >
                                    <option>Horde</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xl-12">
                                <input id="level" type="number" class="form-control" name="level" value="{{$char->level}}" required >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xl-12">
                                <input type="number" class="form-control" name="itemLevel" value="{{$char->itemLevel}}" required  max="950" min="600">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="serveur" class="col-md-2 control-label">Serveur</label>
                            <div class="col-md-6 col-xl-12">
                                <select id="serveur" name="serveur" class="form-control" value="{{old('serveur')}}" required>
